    ...
    <nav class="desktop-nav" id="desktopNav">
      <div class="desktop-nav-inner">
        <a href="${base}index.html" class="desktop-logo">
          ...
          <span style="display: inline-flex; align-items: center; gap: 12px; margin-left: 12px;">
            <span style="color: rgba(255,255,255,0.3);">|</span>
            <span style="font-size: 18px; font-weight: 600; color: rgba(255,255,255,0.9); line-height: 42px;">yalnız değilsin! almanya101 seninle!</span>
          </span>
        </a>
